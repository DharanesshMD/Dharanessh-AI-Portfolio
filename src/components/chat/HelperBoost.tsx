...
const questions = {
  ...
  Experience: 'What is your experience? Where are you working right now?',
...
const questionConfig = [
  ...
  { key: 'Projects', color: '#3E9858', icon: Presentation },
  { key: 'Experience', color: '#0096FF', icon: BriefcaseBusiness },
...
const specialQuestions = [
  'PC Gamer you said?? What games do you play?',
  'Who are you?',
...
const questionsByCategory = [
  ...
  },
  {
    ...
    questions: [
      'What are your skills?',
      'How was your experience at Fidelity Investments?',
    ],
  },
  {
    id: 'fun',
